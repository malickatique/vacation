                    ...
                    <div class="card-footer">
                        ...
                        <div class="col-sm-4 border-right">
                            <div class="description-block">
                                <h5 class="description-header">Registered Properties</h5>
                                <span class="description-text">23</span>
                            </div>
                            <!-- /.description-block -->
                        </div>
                        <!-- /.col -->
                        ...
                        <div class="col-sm-4">
                            <div class="description-block">
                            <h5 class="description-header">Booking Requests</h5>
                            <span class="description-text">17+</span>
                            </div>
                            <!-- /.description-block -->
                        </div>
                        <!-- /.col -->
                    ...
                    <form enctype="multipart/form-data" >
                        ...
                        <div class="modal-body col-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm10">
                                    <input type="file" @change="convertPic" class="file-input" name="user_image">
                                    <has-error :form="form" field="user_image"></has-error>
                                </div>
                            </div>
