...
<section class="hero_in general start_bg_zoom">
        <div class="wrapper">
            <div class="container">
                <h1 class="fadeInUp animated"><span></span>About US</h1>
            </div>
        </div>
    </section>
				...
				<div class="row justify-content-between">
					<div class="col-lg-6 wow" data-wow-offset="150">
						<figure class="block-reveal">
							...
							<img src="{{ asset('site/img/about_1.jpg')}}" class="img-fluid" alt="">
						</figure>
					</div>
					<div class="col-lg-5">
			...
			<div id="carousel" class="owl-carousel owl-theme">
				<div class="item">
					<a href="#0">
						...
						</div><img src="{{ asset('site/img/1_carousel.jpg')}}" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#0">
						...
						</div><img src="{{ asset('site/img/2_carousel.jpg')}}" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#0">
						...
						</div><img src="{{ asset('site/img/3_carousel.jpg')}}" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#0">
						...
						</div><img src="{{ asset('site/img/4_carousel.jpg')}}" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#0">
						...
						</div><img src="{{ asset('site/img/5_carousel.jpg')}}" alt="">
					</a>
				</div>
			</div>
			<!-- /carousel -->
